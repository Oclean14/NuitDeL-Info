	...
	<body>
		...
		<!-- Gigantic Heading -->
			<section class="wrapper style2">
				<div class="container">
					<header class="major">
						<h2>Nous vous connectons avec ceux qui ont besoin de vous</h2>
						<p>Cliquez ici afin de pouvoir discuter avec des réscapés de catastrophes</p>
					</header>
				</div>
			</section>
		...
		<!-- CTA -->
			<section id="cta" class="wrapper style3">
				<div class="container">
					<header>
						<h2>Do you want to help poor people ?</h2>
						<a href="#" class="button">Give your money</a>
					</header>
				</div>
			</section>
					...
					<div class="row">
						<section class="3u 6u(2) 12u$(3)">
							...
							<ul class="links">
								...
								<li><a href="#">Quelles sont les zones que nous couvront ?</a></li>
						...
						<section class="3u 6u$(2) 12u$(3)">
							...
							<ul class="links">
								...
								<li><a href="#">Tous les sujets d'aide</a></li>
								<li><a href="#">FAQ</a></li>
							</ul>
						</section>
						<section class="6u 12u(2)">
